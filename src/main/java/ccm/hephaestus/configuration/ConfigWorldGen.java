...
final class ConfigWorldGen extends Config {
    ...
    protected static void configWorldGen(final AdvConfiguration config) {
        ...
        Properties.enableWorldGenSilver = config.get(ConfigWorldGen.gen + ConfigWorldGen.sil, ConfigWorldGen.ena + ConfigWorldGen.sil, true).getBoolean(true);
        Properties.enableWorldGenSulfur = config.get(ConfigWorldGen.gen + ConfigWorldGen.sul, ConfigWorldGen.ena + ConfigWorldGen.sul, true).getBoolean(true);
        Properties.enableWorldGenTin = config.get(ConfigWorldGen.gen + ConfigWorldGen.tin, ConfigWorldGen.ena + ConfigWorldGen.tin, true).getBoolean(true);
        Properties.enableWorldGenTitanium = config.get(ConfigWorldGen.gen + ConfigWorldGen.tit, ConfigWorldGen.ena + ConfigWorldGen.tit, true).getBoolean(true);
        Properties.enableWorldGenTungsten = config.get(ConfigWorldGen.gen + ConfigWorldGen.tun, ConfigWorldGen.ena + ConfigWorldGen.tun, true).getBoolean(true);
    }
}