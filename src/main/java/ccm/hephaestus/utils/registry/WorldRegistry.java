...
final class WorldRegistry {
    ...
    private static void registerCopper() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreCopper.ordinal()),
                                       EnumOres.oreCopper.name(),
                                       Properties.copSize,
                                       Properties.copDensity,
                                       Properties.copMinHeight,
                                       Properties.copMaxHeight,
    ...
    private static void registerLead() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreLead.ordinal()),
                                       EnumOres.oreLead.name(),
                                       Properties.leadSize,
                                       Properties.leadDensity,
                                       Properties.leadMinHeight,
                                       Properties.leadMaxHeight,
    ...
    private static void registerSilver() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSilver.ordinal()),
                                       EnumOres.oreSilver.name(),
                                       Properties.silSize,
                                       Properties.silDensity,
                                       Properties.silMinHeight,
                                       Properties.silMaxHeight,
    ...
    private static void registerSulfur() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreSulfur.ordinal()),
                                       EnumOres.oreSulfur.name(),
                                       Properties.sulSize,
                                       Properties.sulDensity,
                                       Properties.sulMinHeight,
                                       Properties.sulMaxHeight,
    ...
    private static void registerTin() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTin.ordinal()),
                                       EnumOres.oreTin.name(),
                                       Properties.tinSize,
                                       Properties.tinDensity,
                                       Properties.tinMinHeight,
                                       Properties.tinMaxHeight,
    ...
    private static void registerTitanium() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTitanium.ordinal()),
                                       EnumOres.oreTitanium.name(),
                                       Properties.titSize,
                                       Properties.titDensity,
                                       Properties.titMinHeight,
                                       Properties.titMaxHeight,
    ...
    private static void registerTungsten() {
        ...
        WorldGenerator.addOverworldGen(Archive.MOD_NAME,
                                       new ItemStack(ModBlocks.ores.blockID, 1, EnumOres.oreTungsten.ordinal()),
                                       EnumOres.oreTungsten.name(),
                                       Properties.tunSize,
                                       Properties.tunDensity,
                                       Properties.tunMinHeight,
                                       Properties.tunMaxHeight,
