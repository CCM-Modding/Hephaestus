...
public final class TileConstants {
    ...
    public static final String GRINDER_UNLOCALIZED = TileConstants.CONTAINER + TileConstants.GRINDER_GUID;
    ...
    public static final String BLAST_UNLOCALIZED = TileConstants.CONTAINER + TileConstants.BLAST_GUID;
