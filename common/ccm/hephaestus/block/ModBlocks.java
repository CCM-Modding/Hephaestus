...
public final class ModBlocks {
    ...
    public static void init() {
        ...
        ModBlocks.blockGrinder = new BlockGrinder(Properties.blockGrinderID, false)
                .setUnlocalizedName("blockGrinder").setHardness(3.0F);
        ModBlocks.blockGrinderRunning = new BlockGrinder(Properties.blockGrinderRunningID, true)
                .setUnlocalizedName("blockGrinder").setHardness(3.0F);

        ModBlocks.blockBlast = new BlockBlast(Properties.blockBlastID, false).setUnlocalizedName(
                "blockBlast").setHardness(3.0F);
        ModBlocks.blockBlastRunning = new BlockBlast(Properties.blockBlastRunningID, true)
                .setUnlocalizedName("blockBlast").setHardness(3.0F).setLightValue(0.875F);
