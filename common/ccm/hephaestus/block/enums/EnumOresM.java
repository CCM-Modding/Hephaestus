...
public enum EnumOresM implements IBlockEnum
{
    ...
    oreTin(2), oreAluminum(3), oreSilver(3), oreCopper(2), oreTitanium(4), oreSulfur(3), oreChildarium(2), oreCitrine(3), oreCZirconia(3), oreOlivine(3), oreRuby(3), oreSapphire(3), oreTopaz(
            3);
