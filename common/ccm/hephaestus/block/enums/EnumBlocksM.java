...
public enum EnumBlocksM implements IBlockEnum
{
    ...
    blockTin(2), blockAluminum(3), blockSilver(3), blockCopper(2), blockTitanium(4), blockSulfur(3), blockDarkObsidian(3), blockGravitas(3), blockChildarium(2), blockCitrine(3), blockCZirconia(
            3), blockOlivine(3), blockRuby(3), blockSapphire(3), blockTopaz(3);
