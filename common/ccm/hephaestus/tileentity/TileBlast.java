...
public class TileBlast extends TileBase {
    ...
    public void readFromNBT(final NBTTagCompound nbt) {
        ...
        this.setInventory(InventoryHelper.readInventoryFromNBT(
                nbt.getTagList(TileConstants.INVENTORY), TileBlast.invSize));
    }
    ...
    public void updateEntity() {
        ...
        if (!this.worldObj.isRemote) {
            if (this.blastBurnTime == 0 && this.canSmelt()) {
                this.currentSmeltTime = this.blastBurnTime = TileBlast
                        .getItemBurnTime(this.inventory[1]);
                if (this.blastBurnTime > 0) {
                    flag1 = true;
                    if (this.inventory[1] != null) {
                        --this.inventory[1].stackSize;
                        if (this.inventory[1].stackSize == 0)
                            this.inventory[1] = this.inventory[1].getItem().getContainerItemStack(
                                    this.inventory[1]);
                    }
                }
            }
            ...
            if (flag != this.blastBurnTime > 0) {
                flag1 = true;
                BlockBlast.updateBlockState(false, this.worldObj, this.xCoord, this.yCoord,
                        this.zCoord);
            }
        }
        if (flag1)
        ...
        if (this.inventory[0] != null) {
            if (this.inventory[1] != null && this.inventory[2] != null) {
                if (this.recipe.getSmeltingResult(this.inventory[0]) != null) {
                    final ItemStack itemstack = this.recipe.getSmeltingResult(this.inventory[0])
                            .getOutput1();
