...
final class RecipesSmelting
{
    ...
    public RecipesSmelting()
    {
        ...
        FurnaceRecipes.smelting().addSmelting((EnumOres.oreLead.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotLead), 1.0F);
        FurnaceRecipes.smelting().addSmelting((EnumOres.oreSilver.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotSilver), 1.0F);
        FurnaceRecipes.smelting().addSmelting((EnumOres.oreTin.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotTin), 1.0F);
        ...
        FurnaceRecipes.smelting().addSmelting((EnumDusts.dustHeavyIron.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotHeavyIron), 0.0F);
        FurnaceRecipes.smelting().addSmelting((EnumDusts.dustLead.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotLead), 0.0F);
        FurnaceRecipes.smelting().addSmelting((EnumDusts.dustSilver.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotSilver), 0.0F);
        FurnaceRecipes.smelting().addSmelting((EnumDusts.dustSteel.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotSteel), 0.0F);
        FurnaceRecipes.smelting().addSmelting((EnumDusts.dustTin.ordinal()), EnumHelper.getItemIS(EnumIngots.ingotTin), 0.0F);
    }
}